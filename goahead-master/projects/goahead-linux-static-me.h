...
/* Settings */
    ...
    #define ME_GOAHEAD_LIMIT_POST 4096000000
#endif
#ifndef ME_GOAHEAD_LIMIT_PUT
    #define ME_GOAHEAD_LIMIT_PUT 4096000000
#endif
    ...
    #define ME_GOAHEAD_LIMIT_UPLOAD 4096000000
#endif
    ...
    #define ME_GOAHEAD_UPLOAD_DIR "/mnt/recovery" /* change this path because norflash write is slow */
#endif
